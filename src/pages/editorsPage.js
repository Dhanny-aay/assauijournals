            ...
            : editors.map((journal) => (
                ...
                >
                  ...
                  <div className=" w-full p-4">
                    <p className="m4-3 text-xl text-black font-Ubuntu capitalize font-semibold">
                      {journal.name}
                    </p>
                    <p className="text-gray-500 text-sm font-Ubuntu mt-2">
                      {journal.position}
                    </p>
                    <p className="m4-3 font-Ubuntu font-normal text-sm text-[#000000c3]">
                      {journal.about}
                    </p>
                  </div>
                </div>
